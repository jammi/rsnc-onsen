...
LOAD(() => {
  ...
  [Switch, MaterialSwitch/*, Range, MaterialRange, NavigationBar, NavigationBarItem, NavigationBarWithOutlineButton,
    ...
    PopoverLeft, PopoverRight, Modal, ProgressBar, ProgressCircle, Fab, FabMini*/].forEach(Item => {
      let left = padLeft;
      left += Item.new({
        rect: [left, top],
        parent: app,
